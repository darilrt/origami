...
void Input::init(EngineState &state)
{
  ...
  es.regist<KeyDown>(
      [&](EngineState &state, void *payload)
      {
  ...
  es.regist<MouseButtonDown>(
      [&](EngineState &state, void *payload)
      {
        ...
        this->mouse_buttons_pressed[(uint8_t) static_cast<MouseButtonDown *>(payload)->button] = true;
      });
  ...
  es.regist<MouseButtonUp>(
      [&](EngineState &state, void *payload)
      {
        ...
        this->mouse_buttons_pressed[(uint8_t) static_cast<MouseButtonUp *>(payload)->button] = false;
      });
